...
?><?php if (!isset($category) || $category != $__view->getInjectedVar("category")){$category=$__view->getInjectedVar("category");}if (!isset($title) || $title != $__view->getInjectedVar("title")){$title=$__view->getInjectedVar("title");}if (!isset($products) || $products != $__view->getInjectedVar("products")){$products=$__view->getInjectedVar("products");} ?>
                <?php
    $url = $this->service('url');
    ?>
    <div class="row">
