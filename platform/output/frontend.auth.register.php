...
?><?php if (!isset($errors) || $errors != $__view->getInjectedVar("errors")){$errors=$__view->getInjectedVar("errors");}if (!isset($countries) || $countries != $__view->getInjectedVar("countries")){$countries=$__view->getInjectedVar("countries");} ?>
        <div class="row">
